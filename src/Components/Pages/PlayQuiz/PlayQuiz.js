...
import "./PlayQuiz.css";
import img2 from "../../Images/card.jpg";
import click from "../../Images/click.mp3";
import Playquiztxt from "./Playquiztxt";
...
const PlayQuiz = () => {
  ...
  const play = (id) => {
    //this function will run when the card is clicked.
    ...
    <div style={{ marginTop: "100px" }}>
      <div className="mainContainer">
        <div className="heading">
          <h1>
            {" "}
            <Playquiztxt text="LET'S PLAY QUIZ !!" delay={100} />
          </h1>
        </div>
