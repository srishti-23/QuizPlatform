...
const NewQuizForm = () => {
  ...
  useEffect(() => {
    //useEffect hook to run the timout functions when the "added" and "answerDone" changes
  ...
  const addQuestionHandler = (e) => {
    //this function will run when the addQuestion button will be clicked
    e.preventDefault();
    ...
    if (answers.length >= 2) {
      ...
      if (!hasCorrectAnswer) {
        return alert("Please mark at least one answer as correct!");
      }
  ...
  const onSaveHandler = (event) => {
    // this function will run when saveButton is clicked
    event.preventDefault();
  ...
  const deleteHandler = (id) => {
    // this function will run when delete button inside options is clicked and return the new filtered array
        ...
        <div className="quizForm">
          <form action="" onSubmit={onSaveHandler}>
            ...
            <div className="QA">
              ...
              <TextField
                ...
                sx={{
                  "& .MuiOutlinedInput-root": {
                    "& fieldset": {
                      borderRadius: "20px", // Custom border radius if needed
                    },
                  },
                }}
              />
              ...
              {answerDone && <p>Add atleast 2 answers!</p>}{" "}
              {/*if answerDone is true show <p>Add atleast 2 answers!</p>*/}
            </div>
            ...
            <div className="viewAnswer">
              {answers.map((el, i) => {
                //Mapped the element of array "answers"
                return (
                  <div
                    className="option"
                    key={i}
